...
class XianxiaSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.ranwen8.com/book/101564/32487343.html']

    # def get_infos(self):
    conn = sqlite3.connect('novel_info.db')
    cursor = conn.cursor()
    cursor.execute('SELECT novel_name, novel_start FROM XIANXIA')
    ...
    # print(novel_names)
    #
    # conn = sqlite3.connect('./novel_db/xianxia.db')
    # cursor = conn.cursor()
