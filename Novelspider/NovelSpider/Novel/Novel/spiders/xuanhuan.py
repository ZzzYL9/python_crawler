...
class XuanhuanSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.ranwen8.com/book/115320/41732306.html']

    # def get_infos(self):
    # conn = sqlite3.connect('novel_info.db')
    # cursor = conn.cursor()
    # cursor.execute('SELECT novel_name, novel_start FROM XUANHUAN')
    ...
    # conn = sqlite3.connect('./novel_db/novels.db')
    # cursor = conn.cursor()
