...
class KehuanSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.ranwen8.com/book/106492/35417286.html']

    # def get_infos(self):
    conn = sqlite3.connect('novel_info.db')
    cursor = conn.cursor()
    cursor.execute('SELECT novel_name, novel_start FROM KEHUAN')
    ...
    # print(novel_names)
    #
    # conn = sqlite3.connect('./novel_db/kehuan.db')
    # cursor = conn.cursor()
