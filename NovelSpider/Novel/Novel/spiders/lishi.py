...
class LishiSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.ranwen8.com/book/112608/39489713.html']

    # def get_infos(self):
    conn = sqlite3.connect('novel_info.db')
    cursor = conn.cursor()
    cursor.execute('SELECT novel_name, novel_start FROM LISHI')
    ...
    # print(novel_names)
    #
    # conn = sqlite3.connect('./novel_db/lishi.db')
    # cursor = conn.cursor()
